...
set SERVER_NAME=tiktok-platform
set VERSION=1.0.0
set CONF=conf/application.yml
set SERVER_JAR=%SERVER_NAME%-%VERSION%.jar

set JAVA_OPT=-Xms2g -Xmx2g -Xmn1g -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=320m -XX:+UseG1GC
...
set JAVA_OPT=%JAVA_OPT% -Dloader.path=lib
