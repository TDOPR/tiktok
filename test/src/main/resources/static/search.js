...
api.push({
    alias: 'api',
    order: '1',
    desc: 'CRUD通用功能测试  建议在Idea里面安装 Mybatis X插件提高开发效率',
    link: 'crud通用功能测试  建议在idea里面安装_mybatis_x插件提高开发效率',
    list: []
})
api[0].list.push({
    order: '1',
...
api[1].list.push({
    order: '3',
    desc: '登录 入参方式: @RequestParam',
});
api[1].list.push({
    order: '4',
    desc: '添加用户 入参方式: @RequestBody',
});
api[1].list.push({
    order: '5',
    desc: '删除用户',
